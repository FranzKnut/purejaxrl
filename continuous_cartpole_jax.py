...
gymnasium.envs.register(
    ...
    entry_point='continuous_cartpole_jax:ContinuousCartPoleEnv',
    max_episode_steps=4000,
)


class ContinuousCartPoleEnv(gymnasium.Env):
    """
    Description:
    ...
    def step(self, seed, action):
        ...
        if not done:
            ...
            reward = 0.0
        # truncated = self.steps_beyond_done is not None
        return np.array(self.state), reward, done, {}

    def reset(self, seed):
        self.state = jrandom.uniform(seed, minval=-0.05, maxval=0.05, shape=(4,))
        self.steps_beyond_done = None
        self.elapsed_time = 0.0
